...
export const RECEIVE_TOPICHOME = 'receive_topicHome'
export const RECEIVE_GETTABDATA = 'receive_getTabData'
export const RECEIVE_GETTABDATATWO = 'receive_getTabDataTwo'
